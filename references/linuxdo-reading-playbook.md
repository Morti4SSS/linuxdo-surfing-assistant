...
Use this when actually reading Linux.do with Codex 内置浏览器. The skill exists for Linux.do, so prefer behavior that matches the forum instead of generic web research.
...
1. Title, category, tags, and original post.
2. Author identity and whether they appear to be a repeat high-signal contributor.
3. Accepted answer or high-like replies if visible.
